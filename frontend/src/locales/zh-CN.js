...
export default {
  ...
  workspace: {
    workflowSpace: {
      ...
      'diagnosis_workflow_record_tip': '你现在可以针对具体某一条工作流记录进行诊断，查看各个节点的运行情况、运行时间、消耗积分等信息。',
      'more_actions': '更多操作',
    },
    workflowEditor: {
  ...
  settings: {
    ...
    'azure_gpt_35_deployment_id': 'Azure GPT-3.5 部署 ID',
    'azure_gpt_4_deployment_id': 'Azure GPT-4 部署 ID',
    'azure_gpt_4v_deployment_id': 'Azure GPT-4-Vison 部署 ID',
    'openai_embedding_engine': 'Azure Embedding 部署 ID',
    'chatglm6b_api_base': 'ChatGLM-6B API Base',
    'moonshot_api_base': 'Moonshot API Base',
    'moonshot_api_key': 'Moonshot API Key',
    'zhipuai_api_base': '智谱 AI API Base',
