...
import { createTemplateData } from './ClaudeVision'
...
<template>
  <BaseNode :nodeId="id" :debug="props.data.debug" :fieldsData="fieldsData"
    translatePrefix="components.nodes.mediaProcessing.ClaudeVision" documentPath="/help/docs/media-processing#h2-16" />
</template>