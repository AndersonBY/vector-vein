...
<template>
  <BaseNode :title="t('components.nodes.controlFlows.Empty.title')" :description="props.data.description" documentLink="https://vectorvein.com/help/docs/control-flows#h2-4"
    @delete="deleteNode">
    <template #main>
      <a-row type="flex">
        <a-col :span="24">
