...
<template>
  <BaseNode :nodeId="id" :title="t('components.nodes.controlFlows.RandomChoice.title')"
    :description="props.data.description" documentLink="https://vectorvein.com/help/docs/control-flows#h2-10">
    <template #main>
      <a-row type="flex">
        <a-col :span="24">
