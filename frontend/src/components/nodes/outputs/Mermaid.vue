...
<template>
  <BaseNode :nodeId="id" :fieldsData="fieldsData" :data="props.data" translatePrefix="components.nodes.outputs.Mermaid"
    :debug="props.data.debug" documentPath="/help/docs/outputs#node-Mermaid" />
</template>