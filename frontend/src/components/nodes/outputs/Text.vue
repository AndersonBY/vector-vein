...
<template>
  <BaseNode :nodeId="id" :fieldsData="fieldsData" :data="props.data" translatePrefix="components.nodes.outputs.Text"
    :debug="props.data.debug" documentPath="/help/docs/outputs#node-Text" />
</template>