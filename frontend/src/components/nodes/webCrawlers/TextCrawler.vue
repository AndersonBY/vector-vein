...
<template>
  <BaseNode :nodeId="id" :title="t('components.nodes.webCrawlers.TextCrawler.title')"
    :description="props.data.description" documentLink="https://vectorvein.com/help/docs/web-crawlers#h2-4">
    <template #main>
      <a-row type="flex">
        <a-col :span="24">
