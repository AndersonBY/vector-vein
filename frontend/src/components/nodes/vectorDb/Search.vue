...
<template>
  <BaseNode :nodeId="id" :fieldsData="fieldsData" translatePrefix="components.nodes.vectorDb.Search"
    :debug="props.data.debug" documentLink="https://vectorvein.com/help/docs/vector-db#h2-8" />
</template>