...
class TextSplitter(ABC):
    ...
    def create_documents(self, texts: List[str], metadatas: Optional[List[dict]] = None) -> List[str]:
...
class MarkdownHeaderTextSplitter:
    ...
    def aggregate_lines_to_chunks(self, lines: List[LineType]) -> List[str]:
        ...
        return [chunk["content"] for chunk in aggregated_chunks]
    ...
    def split_text(self, text: str) -> List[str]:
        ...
        if not self.return_each_line:
            ...
            return [chunk["content"] for chunk in lines_with_metadata]
...
class SpacyTextSplitter(TextSplitter):
    ...
    def __init__(self, separator: str = "\n\n", pipeline: str = "en_core_web_sm", **kwargs: Any) -> None:
