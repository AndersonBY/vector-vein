...
# @Last Modified time: 2024-04-30 20:46:45
...
class ZhiPuAIChatClient(BaseChatClient):
...
class AsyncZhiPuAIChatClient(BaseAsyncChatClient):
    """Fake AsyncChatClient for ZhiPuAIChatClient

    Args:
        AsyncChatClient (_type_): _description_
    """
